...
in Figure~\ref{fig:fundamental_domain_for_K} below.
...
\begin{figure}[ht]
    ...
    \label{fig:fundamental_domain_for_K}
\end{figure}
...
Using Figure~\ref{fig:fundamental_domain_for_K} as a visual aid, we see there are eight half-edges in
